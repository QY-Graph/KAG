...
class ReasonerApi(object):
    ...
    def reasoner_dialog_report_completions_post(self, **kwargs):  # noqa: E501
        """report_stream  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.reasoner_dialog_report_completions_post(async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param TaskStreamRequest task_stream_request:
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.reasoner_dialog_report_completions_post_with_http_info(**kwargs)  # noqa: E501

    def reasoner_dialog_report_completions_post_with_http_info(self, **kwargs):  # noqa: E501
        """report_stream  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.reasoner_dialog_report_completions_post_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method reasoner_dialog_report_completions_post" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        ...
        body_params = None
        if 'task_stream_request' in local_var_params:
            body_params = local_var_params['task_stream_request']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
        ...
        return self.api_client.call_api(
            '/reasoner/dialog/report/completions', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
